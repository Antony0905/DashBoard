...
<head>
  ...
  <title>Menu Excluir Demanda | Everis Brazil Admin </title>
  ...
  <link rel="stylesheet" href="../../../global/mycss/view.css">
  <!-- Plugins -->
  ...
  <link rel="stylesheet" href="../../../global/vendor/layout-grid/layout-grid.css">
  <!-- Fonts -->
...
<body class="site-navbar-small ">
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Visualizar Demanda</h1>
    </div>	
    <div class="page-content">
      <div class="panel">
        <div class="panel-heading">
          <h3 class="panel-title">Buscar Demanda Por ID</h3>
          <div>
          	<h1 class="panel-title"> Fase de Desenvolvimento </h1>
          	<div id="main">
        		
				<form action="../../../ViewRms" method="POST">
        			<input type="text" name="idDemanda" id="idDemanda">
  ...
  <script src="../../../global/vendor/layout-grid/layout-grid.js"></script>
  <!-- Scripts -->
