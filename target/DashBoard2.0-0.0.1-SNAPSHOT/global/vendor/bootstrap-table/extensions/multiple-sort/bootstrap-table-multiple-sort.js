...
(function($) {
    ...
    $.extend($.fn.bootstrapTable.locales, {
        formatMultipleSort: function() {
            return 'Ordena&ccedil;&atilde;o Avan&ccedil;ada';
        },
        formatAddLevel: function() {
            return "Adicionar N&iacute;vel";
        },
        formatDeleteLevel: function() {
            return "Remover N&iacute;vel";
        },
        formatColumn: function() {
            return "Coluna";
        },
        formatOrder: function() {
            return "Tipo Ordena&ccedil;&atilde;o";
        },
        formatSortBy: function() {
            return "Ordenado por";
        },
        formatThenBy: function() {
            return "E Ent&atilde;o por";
        },
        formatSort: function() {
            return "Ordenar";
        },
        ...
        formatDuplicateAlertTitle: function() {
            return "Duplica&ccedil;&atilde;o detectada!";
        },
